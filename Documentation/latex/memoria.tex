...
%Para establecer las imagenes exactamente debajo de los parrafos
\usepackage{float}
...
\newcommand{\nombre}{Adrián Aguado García} %%% cambio de comando
\newcommand{\tutorA}{Carlos E.Vivaracho Pascual} %%% cambio de comando
\newcommand{\tutorE}{Fernando Cuenca Cabezas} %%% cambio de comando
\newcommand{\titulo}{Estudio analítico sobre la calidad del aire en la ciudad de Madrid} %%% cambio de comando
...
\begin{abstract}
Environmental pollution is being a problem for human health worldwide. Enormous urban centres are one of the most polluted areas. Various gases, such as nitrogen dioxide \ce{NO2}, are causing governments of different cities to consider measures for their reduction, such as forbid certainly carts to enter to the city center. In this document an analytical model is made for the pollution data of the city of Madrid.
\end{abstract}

\renewcommand*\abstractname{Keywords}
\begin{abstract}
Big Data, Data Visualization, Python, R, data\ldots
\end{abstract}
...
\include{./tex/7_Entorno_experimental}
\include{./tex/8_Resultados}
\include{./tex/9_Conclusiones_Lineas_de_trabajo_futuras}
...
\include{./tex/B_Extra_Resultados}
