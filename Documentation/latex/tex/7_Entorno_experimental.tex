...
\begin{itemize}
	...
	\item \textbf{Página 9} (ver figura \ref{MapaNO2}): Es posible ver aquí otra interpretación de la página anterior. En esta ocasión se representa la  acumulación de \ce{NO2} por zonas y horas de manera visual. Concretamente se hace uso de un mapa utilizando un \textit{plugin} de mapbox. 
	...
	\imagen{powerBidias}{\footnotesize{Ejemplo gráfico por días y zonas. Fuente: Elaboración propia.}\label{powerBidias}}
