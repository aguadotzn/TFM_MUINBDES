...
\begin{itemize}
	...
	limitación ni consecuencias. 
		...
		Los datos de contaminación por \ce{NO2} registrados durante el mes de junio de 2019 en Madrid, muestran dos fases bien diferenciadas: una \textbf{fase inicial} en la que los valores de \ce{NO2} alcanzados fueron muy similares a los correspondientes a los meses de abril y mayo, es
